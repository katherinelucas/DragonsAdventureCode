...
public class RPSManager : MonoBehaviour
{
    ...
    public void ComputerChoice()
    {
      ...
      if(computerChoice==1)
      {
        computerImage.GetComponent<Image>().sprite = rock;
      }
      else if(computerChoice==2)
      {
        computerImage.GetComponent<Image>().sprite = paper;
      }
      else
      {
        computerImage.GetComponent<Image>().sprite = scissors;
      }
    }
    ...
    IEnumerator Wait()
    {
      ...
      print(GlobalVariables.kingdomWon);
      print(GlobalVariables.dressUpWon);
      SceneManager.LoadScene("BallRoomWinScene");
    }
}
